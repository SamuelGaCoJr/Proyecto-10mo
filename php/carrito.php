...
<?php
    ...
    $numerofila = 0;
        ...
        <img src='"; echo "../img/productos/"; echo $mostrar['img']; echo "'"; echo "alt='Chocomilk' class='img-producto'>
            ...
            <span class='precio'>Subtotal $"; echo '<td>'.$mostrar['precio'].'</td>'; echo "</span><br>
            <span class='piezas'>Pzs: "; echo '<td>'.$mostrar['unidades'].'</td>'; echo "</span><br>
            "; echo "<a href=\"del_car.php?nd=$mostrar[id_producto]\""; echo "><button class='quitar-del-carrito'><img class='carrito' src='../img/pagina/carritox.svg' alt=''></button>
            </div>
            </div>
        ";       
    }echo "</div>";
