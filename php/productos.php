...
<aside class="filtros">
    ...
    <form action="fil_price.php" method="POST"><br>
        <h3>Entre precio</h3>
        <p>Precio mínimo</p>
        <input type="number" name="min" class="min-precio" placeholder="Ejemplo: $300">
        <p>Precio máximo</p>
        <input type="number" name="max" class="max-precio" placeholder="Ejemplo: $6,000">
		...
		{    $numerofila++;
            ...
            <div class='producto'> 
                ...
                <div class='texto-producto'>
                    ...
                    <span class='precio'>"; echo '<td>$'.$mostrar['precio'].'.00</td>'; echo "</span><br>
