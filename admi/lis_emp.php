...
$queryusuarios = mysqli_query($conexion, "SELECT * FROM empleados where estatus=0 ORDER BY id_empleado asc");
		...
		{    $numerofila++;    
            ...
            echo "<td style='width:26%'><a href=\"../admi/editar_emp.php?nd=$mostrar[id_empleado]\">Modificar</a> | <a href=\"../admi/eliminar_emp.php?nd=$mostrar[id_empleado]\" >Eliminar</a></td>";           
}
        ?>
    </table>
<script>
